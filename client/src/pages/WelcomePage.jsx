...
const FeatureCard = ({ icon: Icon, title, description, gradient }) => (
  <div className={`group relative p-6 rounded-2xl bg-gradient-to-br ${gradient} hover:shadow-2xl transition-all duration-500 hover:scale-105`}>
    ...
    <div className="relative z-10">
      <div className="mb-4 p-3 rounded-xl bg-white/20 backdrop-blur-sm w-fit">
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20">
          <div className={`text-center transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium text-blue-600 mb-8 shadow-lg">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl p-8 transform rotate-2 hover:rotate-0 transition-transform duration-500">
                <div className="bg-white rounded-2xl p-6 transform -rotate-1">
                  <Camera className="h-16 w-16 text-blue-600 mb-4 mx-auto" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1 relative">
              <div className="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl p-8 transform -rotate-2 hover:rotate-0 transition-transform duration-500">
                <div className="bg-white rounded-2xl p-6">
                  <BarChart3 className="h-16 w-16 text-emerald-600 mb-4 mx-auto" />
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <div className="mb-8">
            <h3 className="text-2xl font-bold mb-2">ExpenseTracker Pro</h3>
            <p className="text-gray-400">The future of financial management</p>
          </div>
          <div className="border-t border-gray-800 pt-8">
            <p className="text-gray-400">© 2025 ExpenseTracker Pro. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
